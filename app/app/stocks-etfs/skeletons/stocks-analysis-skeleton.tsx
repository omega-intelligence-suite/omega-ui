...
export const StocksAnalysisSkeleton: FC = () => {
  return (
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col gap-2 flex-1">
              <div className="h-4 w-40 bg-purple-900/40 rounded animate-pulse" style={{ animationDelay: '100ms' }}></div>
              <div className="h-3 w-52 bg-purple-900/30 rounded animate-pulse" style={{ animationDelay: '200ms' }}></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="h-3.5 w-[95%] bg-purple-900/30 rounded animate-pulse" style={{ animationDelay: '400ms' }}></div>
            <div className="h-3.5 w-[85%] bg-purple-900/30 rounded animate-pulse" style={{ animationDelay: '500ms' }}></div>
          </div>
        </div>
        
        {/* Footer */}
        <div className="h-3 w-32 bg-purple-900/30 rounded animate-pulse" style={{ animationDelay: '600ms' }}></div>
      </div>
